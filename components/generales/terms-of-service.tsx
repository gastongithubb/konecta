...
const TermsOfService: NextPage = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        Bienvenido a <span className="font-semibold">Konecta Group Argentina</span>. Al utilizar nuestros
      ...
      <p className="mb-4">
        ...
        <span className="font-semibold"> Gaston Alvarez </span>. Está prohibida la reproducción, distribución 
      ...
      <p className="mb-4">
        <span className="font-semibold">Konecta Group Argentina</span> no será responsable por daños directos o indirectos
      ...
      <p className="mb-4">
        ...
        <span className="font-semibold">gastonalvarez18@outlook.com</span>.
      </p>
    </div>
  );
};
