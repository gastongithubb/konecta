...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "focus-visible:ring-2 focus-visible:ring-slate-400 dark:focus-visible:ring-slate-800",
      ...
      "data-[state=unchecked]:bg-red-700 dark:data-[state=unchecked]:bg-red-800",
      className
    )}
    {...props}
    ref={ref}
